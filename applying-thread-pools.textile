...
Common rules:
* Sizes should be provided by a configuration mechanism or computed dynamically by consulting *Runtime.availableProcessors*.
...
* For IO intensive or any other blocking tasks: *Nthreads = Ncpu * Ucpu / C*, where *C in [0, 1]* is the ratio of computing time, *Ucpu* is the desired load.
