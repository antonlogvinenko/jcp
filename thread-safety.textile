...
|_. Type |_. Thread safety |
| Stateless | Thread safe |
| Immutable | Thread safe |
| Effectively immutable | Minor issues |
| Mutable | Major issues |

h1. Effectively immutable objects problems:

* Publication safety

h1. Mutable objects problems:

* Not sharing - no problem here
* Sharing - big problem
* Escape - big problem

h1. Sharing mutable objects:
