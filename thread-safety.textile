 ...
 ** Use confinement, any of:
  ...
  *** Stack
  *** Ad-hoc
* Make immutable, any of (definition of immutability):
 ** state can't be modified after construction
 ** all fields are final
 ** properly constructed
* If mutable
 ** If read-only (effectively immutable) -- safely published
 ** Otherwise if write and read needs to be performed from threads
  *** Safely published
 ...
 ** _this_ reference implicitly escapes -- inner class instance using **this** class methods is passed
