...
Only shared mutable objects have issues with atomicity and visibility.
...
* Stop sharing
 ** Literally. I mean it, just don't share.
 ** Use confinement
  *** Thread
  *** Stack
  *** Ad-hoc
* Make stateless
* Make immutable
 ** no atomicity problems
 ** no visibility problems
 ** consider correct immutability definition
